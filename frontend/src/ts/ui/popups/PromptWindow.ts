...
import {PopupWindow, IPopupWindowConfig} from "./PopupWindow";
...
export class PromptWindow extends PopupWindow<string>
{
	...
	constructor(message: string, placeholder: string, defaultValue: string, config: Partial<IPromptWindowConfig> = {})
	{
		super({
			message: message,
	...
	public static open(message: string, placeholder: string = "", defaultValue: string = "", config?: Partial<IPromptWindowConfig>)
	{
